...
var orderList2 = [131, 122, 323, 233, 400, 400, 400, 400, 400]
...
func _on_bell_button_pressed() -> void:
	...
	if orderCode == orderList2[currentCharacter]:
		print("correct!")
	else:
		print("wrong.")	
